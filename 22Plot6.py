sp# -*- coding: utf-8 -*-
"""
Created on Sun Dec 20 08:49:53 2020
...
red_wine.head(5)
'''    
red_wine['quality_label'] = pd.Categorical(red_wine['quality'], 
...
wines = pd.concat([red_wine, white_wine]).reset_index(drop=True)
...
# Joint Plot
jp = sns.jointplot(x='mpg', y='disp', data=mtcars,
...
sns.boxplot(data=wines['sulphates'],  ax=ax)
...
# Box Plots
f, (ax) = plt.subplots(1, 1, figsize=(12, 4), dpi=600)
f.suptitle('MTCARS', fontsize=14)
sns.boxplot(data=mtcars[['mpg','disp']],  ax=ax)
